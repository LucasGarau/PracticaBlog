...
<h1>Nuevo Post</h1>
<form action="/addpost" method="post" class="container">
    <div class="form-group">
        <label for="titol">Titulo Post:</label>
        <textarea type="text" class="form-control" id="titol" name="titol" required minlength="3"></textarea>
    </div>
    <div class="form-group">
        <label for="cos">Cuerpo Post:</label>
        <textarea type="text" class="form-control" id="cos" name="cos" rows="30" required minlength="3"></textarea>
    </div>
